...
\begin{table}[h!]
  ...
  \begin{tabular}{l c c c c c}
    ...
    & -0.046*** & -0.042***  & -0.044*** & -0.000*** & -0.000*** \\
    {} 
    & (0.006)   & (0.006)    & (0.006)   & (0.000)   & (0.000) \\
    
    \rowcolor{gray!33}
    Productivity (\textit{h}-index), $\beta_{h}$ 
    & 1.865*** & 1.901***  & 1.848*** & -0.000*** & -0.000*** \\
    {} 
    & (0.018)  & (0.019)   & (0.018)  & (0.000)   & (0.000) \\
    
    \rowcolor{gray!33}
    Total NSF funding, $\beta_{\$1}$ 
    & -0.005* & -0.004  & -0.004* & -0.000*** & -0.000*** \\
    {} 
    & (0.002) & (0.002) & (0.002) & (0.000)   & (0.000) \\
    
    \rowcolor{gray!33}
    {\#} of NSF grants, $\beta_{N1}$ 
    & 0.013   & 0.009   & 0.007   & -0.000*** & -0.000*** \\
    {} 
    & (0.014) & (0.015) & (0.014) & (0.000)   & (0.000) \\
    
    \rowcolor{gray!33}
    Total NIH funding, $\beta_{\$2}$ 
    & 0.013*** & 0.013***  & 0.013*** & -0.000*** & -0.000*** \\
    {} 
    & (0.003)  & (0.003)   & (0.003)  & (0.000)   & (0.000) \\
    
    \rowcolor{gray!33}
    {\#} of NIH grants, $\beta_{N2}$ 
    & -0.060** & -0.064** & -0.061** & -0.000*** & -0.000*** \\
    {} 
    & (0.019)   & (0.019) & (0.019)   & (0.000)   & (0.000) \\
    ...
    & 0.566*** & 0.559*** & 0.527*** & -0.000*** & -0.000*** \\
    {} 
    & (0.057)  & (0.059)  & (0.058)  & (0.000)   & (0.000) \\
    ...
    \rowcolor{gray!33} 
    Constant 
    & 1.936*** & 1.437*** & 1.566*** & -0.000*** & -0.000*** \\
    {} 
    & (0.268)  & (0.225)  & (0.226)  & (0.000)   & (0.000) \\
